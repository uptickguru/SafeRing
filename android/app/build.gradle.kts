...
android {
    ...
    defaultConfig {
        ...
        minSdk = 26
        targetSdk = 34
        versionCode = System.getenv("GITHUB_RUN_NUMBER")?.toIntOrNull() ?: 16
        versionName = "1.0.16"
    ...
    signingConfigs {
        create("release") {
            ...
            val ksPath = fromEnv("ANDROID_KEYSTORE_PATH") ?: props["storeFile"] ?: "safering-keystore.jks"
            ...
            storePassword = fromEnv("ANDROID_KEYSTORE_PASSWORD") ?: fromEnv("KEYSTORE_PASSWORD") ?: props["storePassword"] ?: "kailey99"
            keyAlias = fromEnv("ANDROID_KEY_ALIAS") ?: props["keyAlias"] ?: "safering"
            keyPassword = fromEnv("ANDROID_KEY_PASSWORD") ?: fromEnv("KEYSTORE_PASSWORD") ?: props["keyPassword"] ?: "kailey99"
        }
    }
